...
<html lang="en">
    <head>
        <title>Алматытелефонстрой</title>
    ...
    <body>
        ...
        <div id="menu">
            <nav class="menu">
                ...
                <a href="pages/service.php"><button class="menuButton">Услуги</button></a>
                <a href="pages/contact.php"><button class="menuButton">Контакты</button></a>
                <a href="pages/archive.php"><button class="menuButton last">Архив</button></a>
            </nav>
        </div>
        ...
        <footer>
            <p>©
                <?php echo date('Y');?>
                Алматытелефонстрой. Все права защищены.
            </p>
        </footer>
